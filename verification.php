...
<?php require "backend/shared/header.php"; ?>
        <header class="site-header signUpBasicHeader">
            ...
            <a href="signup" class="signInLink">New User</a>
        </header>
                ...
                <div class="regFormContainer">
                    ...
                    <div class="stepHeader-body form-container">
                        <div class="header-form-content">
                            <h2>A verification email has been sent to youremail@gmail.com, <?php echo $user['email']; ?> please check your mail to verify your account. </h2>
                        </div>
                    </div>
                </div>
        </div>
